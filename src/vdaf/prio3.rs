...
//! implements the `prio3` [VDAF]. The construction is based on a trasnform of a Fully Linear Proof
//! (FLP) system (i.e., a concrete [`crate::pcp::Value`] into a zero-knowledge proof system on
